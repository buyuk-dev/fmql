...
from fmq.cli.stdin import StdinResult, confirm_prompt, read_stdin_targets
from fmq.edits import EditPlan
from fmq.errors import EditError, FmqError
...
def _resolve_stdin_path(raw: str, ws: Workspace) -> PacketId:
    ...
    Try (a) workspace-relative first (covers `fmq query` output), then
